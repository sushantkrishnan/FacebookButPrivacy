...
if(isset($_POST['signup']))
{
	...
	else
	{
		...
		{
			$que2=mysqli_query("insert into users(Name,Email,Password,Gender,Birthday_Date,FB_Join_Date) values('$Name','$Email','$Password','$Gender','$Birthday_Date','$FB_Join_Date')");
